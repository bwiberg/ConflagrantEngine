...
#define VCT_DIFFUSION_MULTIPLIER 0.8
...
#define VCT_INDIRECT_SPREAD 1.2

#define VCT_DIFFUSE_SIDE_WEIGHT 1.0
#define VCT_DIFFUSE_NORMAL_WEIGHT 1.0
#define VCT_DIFFUSE_STRENGTH 2.0

#define VCT_SPECULAR_STRENGTH 2.0
#define VCT_SPECULAR_DIFFUSION 0.5

#define VCT_OCCLUSION_STRENGTH 0.5
